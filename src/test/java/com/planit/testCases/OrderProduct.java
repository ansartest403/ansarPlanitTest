...
public class OrderProduct extends BaseClass {
	...
	/*
	 * @Description : This method place the order
	 * 
	 * @Return : void
	 * 
	 */
	...
	public void placeOrder(String username, String password, String categories, String iteam, String quantity,
			String columnName, String billingAdress, String shippingAdress) throws InterruptedException, IOException {
